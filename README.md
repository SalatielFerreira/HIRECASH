...
- **Cadastro de candidatos**: botão + na página Candidato abre um modal (fecha pelo X ou por Esc — clicar fora não fecha, pra não perder dados digitados) com o formulário completo; ao salvar, o candidato aparece como uma linha em uma tabela estilo planilha, persistida em `localStorage`.
