...
- **Excluir candidato**: botão direito do mouse em qualquer ponto da linha, na página Candidato, abre um menu de contexto com "Excluir candidato" (em vermelho) — pede confirmação antes de remover. Dentro de um campo em edição, o menu nativo do navegador continua funcionando normalmente (copiar, colar, corretor).
